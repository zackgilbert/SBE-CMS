...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'Installation/templates/structure.tpl', 4, false),array('function', 'url', 'Installation/templates/structure.tpl', 213, false),)), $this); ?>

<html>
<head>
<title>Piwik &raquo; <?php echo ((is_array($_tmp='Installation_Installation')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</title>
...
"><?php echo ((is_array($_tmp='General_Next')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
 &raquo;</a>
		...
		<p style="width: <?php echo $this->_tpl_vars['percentDone']; ?>
%;"></p>
	</div>
