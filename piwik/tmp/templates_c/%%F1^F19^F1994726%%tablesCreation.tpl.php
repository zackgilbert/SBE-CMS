<?php /* Smarty version 2.6.25, created on 2009-11-20 16:47:14
         compiled from Installation/templates/tablesCreation.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'Installation/templates/tablesCreation.tpl', 1, false),array('function', 'url', 'Installation/templates/tablesCreation.tpl', 11, false),)), $this); ?>
...
<?php if (isset ( $this->_tpl_vars['databaseCreated'] )): ?>
	<div class="success"> <?php echo ((is_array($_tmp='Installation_DatabaseCreatedSuccess')) ? $this->_run_mod_handler('translate', true, $_tmp, "'".($this->_tpl_vars['databaseName'])."'") : smarty_modifier_translate($_tmp, "'".($this->_tpl_vars['databaseName'])."'")); ?>
