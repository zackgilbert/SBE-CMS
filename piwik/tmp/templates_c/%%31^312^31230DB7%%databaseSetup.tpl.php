<?php /* Smarty version 2.6.25, created on 2009-11-20 16:45:51
...
<h1><?php echo ((is_array($_tmp='Installation_MysqlSetup')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</h1>

<?php if (isset ( $this->_tpl_vars['errorMessage'] )): ?>
	<div class="error">
		<img src="themes/default/images/error_medium.png">
		<?php echo ((is_array($_tmp='Installation_MysqlErrorConnect')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
:
