<?php /* Smarty version 2.6.25, created on 2009-11-20 16:49:28
         compiled from CorePluginsAdmin/templates/manage.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'CorePluginsAdmin/templates/manage.tpl', 8, false),array('modifier', 'escape', 'CorePluginsAdmin/templates/manage.tpl', 31, false),array('modifier', 'nl2br', 'CorePluginsAdmin/templates/manage.tpl', 31, false),)), $this); ?>
...
"><?php endif; ?>
			...
			<td class="desc">
				<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['plugin']['info']['description'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>

				&nbsp;<cite>By 
					<?php if (isset ( $this->_tpl_vars['plugin']['info']['author_homepage'] )): ?><a title="Author Homepage" href="<?php echo $this->_tpl_vars['plugin']['info']['author_homepage']; ?>
"><?php endif; ?>
