	...
	<div id="message-container" onclick="$(this).remove();">
		...
		<script type="text/javascript">
			$('#message-container').hide().fadeIn('slow').animate({opacity:1.0}, 8000).fadeOut(500).fadeIn(500).fadeOut(500).fadeIn(500)<?php if (message('type') == 'success') : ?>.animate({opacity:1.0}, 5000).fadeOut(500, function() { $(this).remove(); })<?php endif; ?>;
		</script>
