...
(function($) {
	...
	$.extend($.ui.sortable.prototype, {
		...
		start: function(that, e) {
			...
			// ZG - 2/9/08 - this was added to make sure % widths stay how they should
			$(this.helper).css('width', (this.element.offsetWidth-2)+'px');
		...
		drag: function(that, e) {
			...
			// ZG - 2/9/08 - Restrict movement to just vertical... this should be built into options.
